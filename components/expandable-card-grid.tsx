...
const cards = [
  {
    description:
      "Abriga três laboratórios temáticos, cada um com um foco especifico e complementar.",
    title: "Apple LAB",
      ...
      return (
        <p>
          <span className="font-bold">
            LIA - Laboratório de Inteligência Artificial Aplicações:{" "}
          </span>
          análise de dados, machine learning, visão computacional, IA aplicada à
          saúde, negócios e demais áreas.
        </p>
      );
    },
  },
