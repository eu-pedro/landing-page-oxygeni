...
export function AppleLabSpace() {
  return (
    <section className="relative w-full bg-linear-to-b from-[#2A0140] to-[#4A0B78] py-12 sm:py-16 lg:py-20 overflow-hidden">
          ...
          <div className="space-y-6 sm:space-y-8">
            ...
            <div>
              ...
              <p className="text-sm sm:text-base">
                ...
                saúde, negócios e demais áreas. Apoia pesquisas em processamento
                de dados, automação de processos e algoritmos preditivos.
                Voltado para Ciência da Computação, Sistemas de Informação,
                Administração, Direito e Saúde (IA aplicada à saúde e à justiça).
              </p>
            </div>
            ...
            <div>
              ...
              <p className="text-sm sm:text-base">
                ...
                para Design, Comunicação, Publicidade, Arquitetura e Computação.
              </p>
            </div>
          </div>
      ...
      <div className="absolute -right-10 sm:right-10 lg:right-20 top-[51.2%] -translate-y-1/2 w-[380px] sm:w-[520px] lg:w-[800px] opacity-[0.16] hidden md:block">
        <Image
